...
function sendScoreToSheet(username, paket, score) {
  ...
  fetch(SPREADSHEET_URL, {
    method: "POST",
    mode: "cors",                // ganti dari no-cors ke cors (paling penting untuk mobile)
  ...
  .catch(err => {
    ...
    // Fallback GET kalau POST tetep gagal (Apps Script support doGet)
...
// ===========================
// Finish Exam (dengan native bridge support)
// ===========================
function finish() {
